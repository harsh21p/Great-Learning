...
function renderPicture(img){
  let displayPic = document.getElementById("display-image");
  var template = `<img src = "${img.basics.image}">;`
  displayPic.appendChild(template);
}
...
function updateAfterSearch() {
  ...
  if (searchResults.length === 0) {
    listDiv.innerHTML = `
			<div class="search-result" style="border: 1px solid black; padding: 20px;width:360px;height:195px;">
				<img width='80' height='80' src='assets/error.png' alt='No results found'/>
